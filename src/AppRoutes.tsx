...
// The shared route table. Rendered under <BrowserRouter> on the client
// (src/App.tsx) and under <StaticRouter> during build-time prerendering
// (src/entry-server.tsx) so the live SPA and the prerendered HTML stay in sync.
//
// NOTE: scripts/prerender.ts maintains an explicit list of these paths to
// generate static HTML for each. If you add/remove a route here, update that
// list (dynamic slugs are derived automatically from src/data/seo.ts).
